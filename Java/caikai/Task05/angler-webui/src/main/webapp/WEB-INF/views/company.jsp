...
<main>
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12 firm">
                <a class="firm-left" href="./1.html">首页</a>
                <a class="firm-center"></a>
                <a class="firm-right" href="./2.html">合作企业</a>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row total">
            <div class="col-md-4  col-sm-6 col-xs-12 lump-boss">
                <div class="lump">
                    <b class="lump-txt">合作企业</b>
                    <a href="">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12 say">
                <div class="say-boss">
                    <div class="say-top">
                        <img src="./images/tdlogo.png" alt="">
                        <p class="say-txt">
                            土豆网公司成立于1998年11月， 是目前中国最大的互联网综合服务提供商之一，也是
                            中国服务用户最多的互联网企业之一。成立10多年以来，腾讯一直秉承一切以用户价值为依
                            归的经营理念，始终处于稳健、高速发展的状态。2004年6月16日，腾讯公司在香港联交所主
                            板公开上市（股票代号700）。
                        </p>
                    </div>
