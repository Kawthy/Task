...
//        students.get(1).setCreateAt(System.currentTimeMillis());
        logger.info(students.get(1).getId());
//        logger.info(students.get(1).getCreateAt());
    ...
    public String profession(Model model){
        ...
        logger.info("company==============="+professions);
